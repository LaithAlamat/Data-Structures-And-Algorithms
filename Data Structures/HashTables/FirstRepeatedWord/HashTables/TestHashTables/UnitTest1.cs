...
namespace TestHashTables
{
    public class UnitTest1
    {
        ...
        {
            string input = "some people need to attend to more events";
            string output = FirstRepeatedWordInAString(input);
            string expected = "to";
            Assert.Equal(expected, output);
        }

        [Fact]
        public void TwoRepeatedWordTest()
        {
            string input = "hello good hello good";
            string output = FirstRepeatedWordInAString(input);
        ...
        [Fact]
        public void TwoRepeatedWordTest2()
        {
            string input = "hello good good hello";
            string output = FirstRepeatedWordInAString(input);
